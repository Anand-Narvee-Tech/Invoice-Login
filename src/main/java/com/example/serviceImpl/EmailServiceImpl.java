...
public class EmailServiceImpl implements EmailService {
	...
	public void sendRegistrationEmail(String toEmail,
		...
		try {
	        ...
	        mailContent.append("<body style='margin:0; padding:0; font-family: Arial, sans-serif; background-color:#f4f6f9;'>");
	        ...
	        // Footer
	        mailContent.append("<tr>");
	        mailContent.append("<td style='background:#f3f4f6; text-align:center; padding:15px; font-size:13px; color:#6b7280;'>");
